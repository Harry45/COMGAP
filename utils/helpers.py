...
def store_list(list_to_store: list, folder_name: str, file_name: str) -> None:
...
def read_list(folder_name: str, file_name: str) -> list:
...
def emcee_chains(folder_name: str, file_name: str, save=True) -> np.ndarray:
    ...
    # the pkl file
    pkl_file = read_list(folder_name, file_name)
